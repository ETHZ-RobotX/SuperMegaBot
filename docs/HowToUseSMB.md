...
- [How to Use SMB?](#how-to-use-smb)
  ...
  - [Brief Information About SMB](#brief-information-about-smb)
    - [SMB](#smb)
...
## Brief Information About SMB

### SMB
<p align="center">
  <img style="float: right;"  src="../Images/SMB.jpg" width="300" title="asd">
</p>
...
When driving the SMB base using the RC transmitter, there is an additional switch on the RC remote to stop all motor movement. It is located on the lower back left of the RC remote (Switch A) and can be used to activate the safety stop functionality of the motor controller powering the motors. The safety stop is activated with switch A in the lower position (0).\
...
1. Before doing anything else, be sure that emergency stop buttons are in the activated position so that the motors cannot be powered up.
   * The Emergency stop button on the back panel is activated.
